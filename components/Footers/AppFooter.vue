...
<template>
  <footer class="bg-yellow-600 w-full">
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-16 mx-auto">
      <!-- Grid -->
      ...
      <div class="grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
        <div class="flex justify-between items-center">
          <p class="text-sm text-white">© 2023 E-Learning Platform. All rights reserved.</p>
        </div>
        <!-- End Col -->
