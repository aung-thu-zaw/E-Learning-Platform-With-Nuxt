...
const props = defineProps({
  class: {
    type: String,
    default: 'text-white bg-yellow-500 hover:bg-yellow-600 rounded-md w-full'
  },
...
<template>
  <button
    type="submit"
    class="text-sm text-white capitalize font-medium py-3 active:animate-press duration-200 transition-all"
