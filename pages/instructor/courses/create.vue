...
<template>
  <div class="container mx-auto md:mx-20 h-auto space-y-5">
    <div class="flex flex-col items-center justify-center">
      ...
      <div class="flex items-center justify-end w-full space-x-5">
        <FormButton class="w-[150px] text-white bg-yellow-500 hover:bg-yellow-600 rounded-md">
          <i class="fa-solid fa-file-pen"></i>
          Save as draft
        </FormButton>
        <FormButton class="w-[200px] text-white bg-blue-600 hover:bg-blue-700 rounded-md">
