  ...
  <section class="py-12">
    <div class="container mx-auto px-5 space-y-10">
      <div class="flex flex-col items-start">
        ...
        >
          <p class="font-bold text-sm text-gray-800">{{ $t('Filter By') }} &nbsp; :</p>
            ...
            <div class="flex items-start justify-between md:px-0 px-5">
              <div class="space-y-3">
                <div class="flex items-center space-x-3">
                  <h1 class="font-bold text-gray-800 text-2xl">{{ $t('Learning Paths') }}</h1>
                  <p class="font-semibold text-gray-700 text-sm">
                    ({{ learningPaths?.meta?.total }} {{ $t('Results') }})
                  </p>
                </div>
              </div>
        ...
        <div>
          <div v-if="courses?.data?.length" class="space-y-10">
            <div class="flex items-start justify-between md:px-0 px-5">
              <div class="space-y-3">
                <div class="flex items-center space-x-3">
                  <h1 class="font-bold text-gray-800 text-2xl">{{ $t('Courses') }}</h1>
                  <p class="font-semibold text-gray-700 text-sm">
